...
export default function About() {
  return (
    <section className="relative py-32 px-8 bg-[#111]">
      <div className="max-w-7xl mx-auto">
        
        {/* Section 01: Profile */}
        <StickySection number="01" title="WHO AM I" align="right">
          <div className="space-y-12">
            <h3 className="text-5xl md:text-7xl font-black leading-[0.9] text-white tracking-tighter">
...
I'm a 15-year-old software developer focused on systems programming and emerging technologies. I build projects that deepen my understanding, and I share my work openly so others in the community can learn from it.<br /> <br />I believe that software should not just be functional, but also elegant and inspiring.
        ...
        {/* Quote Section */}
        <div className="py-60 flex justify-center items-center overflow-hidden">
             <h2 className="text-[8vw] font-black text-center leading-[0.8] tracking-tighter text-white select-none hover:text-zinc-300 transition-colors duration-500 cursor-default">
